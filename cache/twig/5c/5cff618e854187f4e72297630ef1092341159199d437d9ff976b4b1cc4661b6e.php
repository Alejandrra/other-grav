...
class __TwigTemplate_c077460d7885e433fec7d66e9e8e9b61695378db60ee3669afd2bbb2989aaa45 extends \Twig\Template
{
   ...
   <div class=\"row\">
      <div class=\"large-12 columns\">
        ...
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "widget", []), "title", [])) {
            ...
            echo $this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "widget", []), "title", []);
            echo "</h1>
                    ";
        }
        // line 11
        ...
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "widget", []), "description", [])) {
            // line 13
            echo "                        <p>";
            echo $this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "widget", []), "description", []);
            echo "</p>
                      ";
        }
        // line 15
        ...
        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "widget", []), "link", []), "url", []) || $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "widget", []), "link", []), "text", []))) {
            ...
            echo $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "widget", []), "link", []), "url", []);
            echo "\">";
            echo $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["site"] ?? null), "footer", []), "widget", []), "link", []), "text", []);
            echo "</a></p>
                        ";
        }
        // line 18
...
", "partials/footer.html.twig", "/var/www/html/grav/user/themes/gateway/templates/partials/footer.html.twig");
    }
}
