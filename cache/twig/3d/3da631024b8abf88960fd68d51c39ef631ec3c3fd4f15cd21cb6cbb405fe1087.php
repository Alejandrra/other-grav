...
class __TwigTemplate_2b4cae86648a5066f2503f6f4f6acb8126d507518a47a26a3ce0d8e476002001 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["truncate"] ?? null)) {
            if ($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", []), "post_class", [])) {
                echo $this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", []), "post_class", []);
            }
        }
...
($context["truncate"] ?? null)) {
      ...
      ";
            // line 52
            echo strip_tags(\Grav\Common\Utils::truncate($this->getAttribute(($context["page"] ?? null), "content", []), 550));
            echo "
      <a href=\"";
            // line 53
            echo $this->getAttribute(($context["page"] ?? null), "url", []);
    ...
    ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["bar"]) {
                    ...
                    if (($this->getAttribute($context["bar"], "position", []) == "top")) {
                        ...
                        echo $this->getAttribute($context["bar"], "percent", []);
                        echo "%\">
          <div class=\"rescue-progressbar-title\" style=\"background: ";
                        // line 63
                        echo $this->getAttribute($context["bar"], "background", []);
                        echo ";\"><span>";
                        echo $this->getAttribute($context["bar"], "title", []);
                        echo "</span></div>
    ...
    ";
      ...
      ";
            ...
            <h3 class=\"rescue-toggle-trigger\">";
                        // line 78
                        echo $this->getAttribute($context["toggle"], "title", []);
                        echo "</h3>
            <div class=\"rescue-toggle-container\">";
                        // line 79
                        echo $this->getAttribute($context["toggle"], "description", []);
                        echo "</div>
          </div>
        ";
                    }
...
{% if not truncate %}
  ...
  {% endif %}
{% endif %}
", "partials/blog_item.html.twig", "/var/www/html/grav/user/themes/gateway/templates/partials/blog_item.html.twig");
    }
}
